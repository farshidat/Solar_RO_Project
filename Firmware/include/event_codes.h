...
// All event codes are written to the NVS circular buffer (survive reboot).
// Cleared only by System Reset (then L301 is logged).
...
#define EVENT_NVS_CAP  40   // circular history (all codes)
